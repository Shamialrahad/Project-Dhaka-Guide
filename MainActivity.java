...
public class MainActivity extends AppCompatActivity
    ...
    Button Button,ButtonH,ButtonVP,Buttonatm,Buttongd,Buttonf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ButtonH=(Button)findViewById(R.id.button1);
        Button = (Button)findViewById(R.id.button4);
        ButtonVP=(Button)findViewById(R.id.button3);
        Buttonatm=(Button)findViewById(R.id.button6);
        Buttongd=(Button)findViewById(R.id.button5);
